...
BEGIN
    ...
    INSERT INTO plot_location (azimuth, distance, radius, geometry, no_entities)
        VALUES (100, 500, 100, ST_GeomFromText('POINT(20 20)', 4326), FALSE)
    ...
    INSERT INTO deadwood (plot_location_id, tree_species_group, dead_wood_type, decomposition, length_height, diameter_butt, diameter_top, count, bark_pocket) VALUES (temp_deadwood_location_id, '2', '2', '2', 10, 160, 100, 10, 10);
END $$
